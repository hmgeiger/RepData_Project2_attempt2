...
translations_1_to_100 <- c("High Surf","Coastal Flood","Flash Flood","Lightning","Thunderstorm Wind","Thunderstorm Wind","Waterspout","Strong Wind","NA","Excessive Heat","Heat","Heavy Rain","Heavy Snow","Frost/Freeze",NA,"Storm Surge/Tide","Astronomical Low Tide","Avalanche","Avalanche","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Drought","Cold/Wind Chill","Cold/Wind Chill","Winter Weather","Winter Weather","Blizzard","Blizzard","Blizzard","Blizzard","Blizzard","Blizzard","Blizzard","Blizzard","Blizzard","Dust Storm","Winter Storm","Winter Storm","Winter Storm","Winter Storm","Winter Storm","Winter Storm","Storm Surge/Tide","Storm Surge/Tide","Flash Flood","Wildfire","Wildfire","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Coastal Flood","Tropical Storm","Tropical Storm","Coastal Flood","Coastal Flood","Coastal Flood","Tropical Storm","Cold/Wind Chill","Cold/Wind Chill","Funnel Cloud","Funnel Cloud","Funnel Cloud","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Cold/Wind Chill","Winter Weather","Winter Weather","Coastal Flood","Flash Flood","Flash Flood","Frost/Freeze","Frost/Freeze","Hail","Dense Fog","Dense Smoke","Thunderstorm Wind","Thunderstorm Wind","NA","Winter Weather","Drought","Drought","NA","Heat","Heat","Heat")
...
original_vs_translations <- data.frame(Original = original_list_evtypes,Translation = translations,stringsAsFactors=FALSE)
```
...
## 5             Beach Erosion Thunderstorm Wind
## 6                 BLACK ICE Thunderstorm Wind
## 91               HEAVY SURF Thunderstorm Wind
## 92      Heavy surf and wind Thunderstorm Wind
## 137     Mixed Precipitation Thunderstorm Wind
## 145           NON-TSTM WIND Thunderstorm Wind
## 146                   Other Thunderstorm Wind
## 147                   OTHER Thunderstorm Wind
## 176 THUNDERSTORM WIND (G40) Thunderstorm Wind
## 177          Tidal Flooding Thunderstorm Wind
## 178          TIDAL FLOODING Thunderstorm Wind
## 185               TSTM WIND Thunderstorm Wind
## 186            TSTM WIND 40 Thunderstorm Wind
## 187          TSTM WIND (41) Thunderstorm Wind
## 188            TSTM WIND 45 Thunderstorm Wind
## 189 TSTM WIND AND LIGHTNING Thunderstorm Wind
## 190         TSTM WIND (G35) Thunderstorm Wind
## 191         TSTM WIND (G40) Thunderstorm Wind
## 192         TSTM WIND (G45) Thunderstorm Wind
## 193           TSTM WIND G45 Thunderstorm Wind
## 194        TSTM WIND  (G45) Thunderstorm Wind
...
```
##  [1] "DAMAGING FREEZE"    "DAM BREAK"          "HARD FREEZE"       
##  [4] "HAZARDOUS SURF"     "HIGH SEAS"          "LIGHTNING"         
##  [7] "Light snow"         "Light Snow"         "LIGHT SNOW"        
## [10] "Light Snowfall"     "Marine Accident"    "SNOW AND ICE"      
## [13] "SNOW SQUALL"        "SNOW SQUALLS"       "STORM SURGE"       
## [16] "STORM SURGE/TIDE"   "WINTER WEATHER"     "WINTER WEATHER MIX"
## [19] "WINTER WEATHER/MIX" "Wintry Mix"         "WINTRY MIX"
```
...
```
## [1] "AGRICULTURAL FREEZE" "HIGH WIND (G40)"     "SMALL HAIL"
```
